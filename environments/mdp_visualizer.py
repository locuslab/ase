...
def visualize_learning(mdp, agent, draw_state, cur_state=None, scr_width=720, scr_height=720, delay=0):
    ...
    agent_shape = _vis_init(screen, mdp, draw_state, cur_state, agent, value=True, score=score)
    done = False
    ...
    while not done:
        ...
        agent_shape = draw_state(screen, mdp, cur_state, agent=agent, show_value=False, draw_statics=True,
